        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="app-link">
                            ...
                            <a href="#" class="btn btn-primary">
                                <img src="{{ URL::asset('assets/images/android.svg') }}" alt="android">
                            </a>
                            <br>
                            <div class="mt-3"></div>
                            <a href="#" class="btn btn-primary">
                                <img src="{{ URL::asset('assets/images/apple.svg') }}" alt="apple">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xxl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{url('/settings-profile')}}" class="btn btn-primary">Edit</a>
                    </div>
                    <div class="card-body">
                        <form class="row">
            ...
            <div class="col-xxl-8 col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5>Account Status : <span class="text-warning">Pending <i class="icofont-warning"></i></span>
                        </h5>
