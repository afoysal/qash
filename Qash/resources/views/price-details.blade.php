                ...
                <div class="card">
                    <div class="card-body">
                        <div class="this-coin-price">
                            ...
                            <span class="text-danger">-0.2.30% <i class="icofont-arrow-down"></i></span>
                        </div>
                        <div id="btcChart"></div>
                            ...
                            <div class="copy-link">
                                <form action="#">
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="https://www.Qash.io/join/12345">
                    ...
                    <div class="card-body">
                        <div class="price-deposit">
                            <form action="#">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" value="35Hb5B6qJa5ntYaNFN3hGYXdAjh919g2VH">
                                    <span class="input-group-text">Copy</span>
                                </div>
                            </form>
                        </div>
                        <div class="mt-4">
                            <a href="#" class="btn btn-primary btn-block">Withdraw BTC</a>
                        </div>
                    </div>
                </div>
            </div>
